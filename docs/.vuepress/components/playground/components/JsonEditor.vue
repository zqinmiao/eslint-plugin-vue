<template>
  <div
    :class="{ 'json-editor-dark': dark }"
    class="json-editor-root"
  >
    <transition
      name="json-editor-fade"
      @before-enter="fadeIn"
    >
      <div
        v-if="monaco"
        key="editor"
        class="json-editor-swap-container"
      >
        <div
          ref="monaco"
...
.json-editor-placeholder-loading-icon > div {
    ...
    animation: VueEslintEditorLoadingIcon 1s linear infinite;
}
...
@keyframes VueEslintEditorLoadingIcon {
    0% {
